...
output "public_subnet_cidrs" {
  value = "${module.public_subnet.cidr_blocks}"
}
...
output "private_subnet_cidrs" {
  value = "${module.private_subnet.cidr_blocks}"
}

output "ephemeral_subnet_ids" {
  value = "${module.ephemeral_subnet.subnet_ids}"
}

output "ephemeral_subnet_cidrs" {
  value = "${module.ephemeral_subnet.cidr_blocks}"
}
...
output "nat_eip_public_ips" {
  value = "${module.nat.nat_eip_public_ips}"
}

output "nat_eip_private_ips" {
  value = "${module.nat.nat_eip_private_ips}"
}
