...
variable "private_offset_cidr"    { 
    default = "10.0.1.0/16" 
    description = "Where to start counting from for private subnets, so they are the odd-compliment of the corresponding public subnet."
}
